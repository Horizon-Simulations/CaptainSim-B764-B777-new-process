import { GeoCircle, GeoPoint, GeoPointReadOnly, LatLonInterface } from '../geo';
import { NumberUnitReadOnly, UnitFamily } from '../math';
import { Facility, FlightPlanLeg } from '../navigation/Facilities';
import { CircleVectorBuilder, DirectToPointBuilder, GreatCircleBuilder, JoinGreatCircleToPointBuilder, ProcedureTurnBuilder, TurnToCourseBuilder } from './FlightPathVectorBuilder';
 ...
 */
export declare class FixToDmeLegCalculator extends AbstractFlightPathLegCalculator {
    private readonly vec3Cache;
    private readonly geoPointCache;
    private readonly geoCircleCache;
    private readonly intersectionCache;
