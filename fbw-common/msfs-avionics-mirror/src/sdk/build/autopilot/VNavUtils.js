...
export class VNavUtils {
     ...
     */
    static getNextClimbConstraint(verticalPlan, globalLegIndex) {
        const currentConstraint = VNavUtils.getConstraintFromLegIndex(verticalPlan, globalLegIndex);
        if ((currentConstraint === null || currentConstraint === void 0 ? void 0 : currentConstraint.type) === 'climb' && (currentConstraint === null || currentConstraint === void 0 ? void 0 : currentConstraint.maxAltitude) < Number.POSITIVE_INFINITY) {
