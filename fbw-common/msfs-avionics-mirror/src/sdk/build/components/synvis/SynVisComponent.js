...
export class SynVisComponent extends DisplayComponent {
     ...
     */
    render() {
        return (FSComponent.buildComponent(BingComponent, { ref: this.bingRef, id: this.props.bingId, mode: EBingMode.HORIZON, onBoundCallback: this.onBingBound, resolution: this.props.resolution, earthColors: this.props.earthColors, skyColor: this.props.skyColor, class: this.props.class }));
    }
}
