 ...
 */
export declare type ModuleRecord = Record<string, any>;
/**
 * A record of `string`-keyed map layers.
 */
export declare type LayerRecord = Record<string, any>;
/**
 * A record of `string`-keyed map controllers.
 */
export declare type ControllerRecord = Record<string, any>;
/**
 * A record of context properties.
 */
export declare type ContextRecord = Record<string, any>;
/**
 * An empty record.
 */
export declare type EmptyRecord = Record<never, never>;
/**
 ...
 */
export declare type ModuleUnion<Modules extends ModuleRecord, New extends ModuleRecord> = Omit<Modules, keyof New> & New;
/**
 * Adds all modules from a new layer record to an existing record. Layers from the new record will overwrite the ones
 * in the existing record if there are key collisions.
 */
export declare type LayerUnion<Layers extends LayerRecord, New extends LayerRecord> = Omit<Layers, keyof New> & New;
/**
 ...
 */
export declare type ControllerUnion<Controllers extends ControllerRecord, New extends ControllerRecord> = Omit<Controllers, keyof New> & New;
/**
 ...
 */
export declare type ContextUnion<Context, New extends ContextRecord> = Omit<Context, keyof Omit<New, keyof MutableMapContext<MapSystemContext>>> & Omit<New, keyof MutableMapContext<MapSystemContext>>;
/**
 * Retrieves a map layer's required modules.
 */
export declare type RequiredLayerModules<Layer> = Layer extends MapLayer<infer P> ? P extends MapLayerProps<infer M> ? M : never : never;
/**
 * Retrieves a map controller's required modules.
 */
export declare type RequiredControllerModules<Controller> = Controller extends MapSystemController<infer M, any, any, any> ? M : never;
/**
 * Retrieves a map controller's required layers.
 */
export declare type RequiredControllerLayers<Controller> = Controller extends MapSystemController<any, infer L, any, any> ? L : never;
/**
 * Retrieves a map controller's required context.
 */
export declare type RequiredControllerContext<Controller> = Controller extends MapSystemController<any, any, any, infer Context> ? Context : never;
/**
 * A compiled map from {@link MapSystemBuilder}.
 */
export declare type CompiledMapSystem<Modules extends ModuleRecord, Layers extends LayerRecord, Controllers extends ControllerRecord, Context extends ContextRecord> = {
...
//# sourceMappingURL=MapSystemTypes.d.ts.map